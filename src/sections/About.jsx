    ...
    <Section id="about" eyebrow="About" title="Engineering reliable systems with clean fundamentals.">
      <div className="glass-card grid gap-8 rounded-2xl p-6 sm:p-8 lg:grid-cols-[320px_1fr] lg:p-10">
        <div className="flex items-center justify-center">
          <div className="relative h-50 w-60 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-500 p-1 shadow-glow">
            <img
              src="/Profile_GPT.svg"
              alt="Abhishek Kumar"
              className="h-25 w-25 rounded-2xl bg-slate-900 object-cover"
            />
          </div>
        </div>
        <div>
